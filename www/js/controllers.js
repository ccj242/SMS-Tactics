...
$.post( "**backend**", { number: $scope.games[i].number, message: 'Your WinWord for SMS tactics is "' + $scope.games[i].oWW[0] + '". Be sure to save this!', password:"" }, function(res){if (!res){alert('WinWord could not be sent to opponent')}} );
...
$.post( "**backend**", { number: $scope.games[i].number, message: 'Your WinWord for SMS tactics is "' + $scope.games[i].oWW[0] + '". Be sure to save this!', password:"" }, function(res){alert(res)});
